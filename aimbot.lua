...
local function MoveCameraToTarget(targetPos)
    -- Ajusta a CFrame da câmera para olhar diretamente para o alvo
    ...
    if Holding and _G.AimbotEnabled then
        ...
        if targetPlayer then
            ...
            if targetPart then
                ...
                -- Mover a câmera para o alvo de forma brusca
                MoveCameraToTarget(targetPos)
            end
        end
    end
end)
